...
<div id="TitleArea">
	...
	<div id="TitleArea_Title">
		<div id="TitleArea_Title_Content">
					...
					<img border="0" width="13" height="13" src="style/images/title_arrow.gif"/> 更新电影
...
<div id="MainArea">
	<!-- 表单内容 -->
	<form action="updatefilm2" method="post" enctype="multipart/form-data">
		<!-- 本段标题（分段标题） -->
        ...
        <div class="ItemBlockBorder">
            <div class="ItemBlock">
				...
				<table cellpadding="0" cellspacing="0" class="mainForm">
					   <tr>
							<td width="80px">电影ID</td>
							<td><input type="text" name="filmid" class="InputStyle" value="${film.id}" readonly/> *</td>
						</tr>
                    <tr>
						...
						<tr>
							<td width="80px"><img src="film_images/${film.imagename}" width="100%" /></td>
							<td>	
